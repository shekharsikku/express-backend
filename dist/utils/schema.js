...
exports.messageSchema = exports.passwordSchema = exports.profileSchema = exports.signInSchema = exports.signUpSchema = exports.validateSchema = void 0;
...
const messageSchema = zod_1.z
    ...
    message: "Text is required if type is 'text', and File is required if type is 'file'",
    path: ["text", "file"],
});
