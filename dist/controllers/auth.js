...
exports.deleteTokens = exports.refreshAuth = exports.signOutUser = exports.signInUser = exports.signUpUser = void 0;
...
const signInUser = async (req, res) => {
    try {
        ...
        const existsUser = await user_1.default.findOne({
            $or: conditions,
        }).select("+password +authentication -friends");
        if (!existsUser) {
...
const signOutUser = async (req, res) => {
    ...
    await (0, redis_1.delData)(requestUser._id);
...
const deleteTokens = async (req, res) => {
    try {
        ...
        const deleteResult = await user_1.default.updateOne({ _id: userId }, {
            $pull: {
                authentication: { expiry: { $lt: currentDate } },
            },
        });
        return (0, utils_1.ApiResponse)(res, 200, "Expired tokens deleted!", {
            date: currentDate,
            result: deleteResult,
        });
    }
