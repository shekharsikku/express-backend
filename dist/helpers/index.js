...
exports.generateSecureCode = exports.publicIpAddress = exports.createAccessData = exports.maskedDetails = exports.removeSpaces = exports.hasEmptyField = exports.authorizeCookie = exports.generateRefresh = exports.generateAccess = exports.compareHash = exports.generateHash = void 0;
...
const generateSecureCode = (length = 6) => {
    ...
    const code = Array.from(crypto_1.default.randomBytes(length))
